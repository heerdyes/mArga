public class RAM256x8{
  ...
  public static void main(String[] args){
    RAM256x8 r=new RAM256x8();
    r.feed("00000000","1","10101100");r.display();
    r.feed("00000010","1","10100000");
    r.feed("00000100","1","00111100");
    r.feed("00100100","1","11101110");r.display();
    r.feed("01000000","1","10001000");
    r.feed("00100010","1","00100100");r.display();
    r.feed("10010000","1","10110100");
    r.feed("10100110","1","11011011");r.display();
  }
